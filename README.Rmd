...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/epixproject/dplyrx?branch=master&svg=true)](https://ci.appveyor.com/project/epixproject/dplyrx)
